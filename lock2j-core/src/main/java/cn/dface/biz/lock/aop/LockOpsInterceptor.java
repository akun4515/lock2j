...
import cn.dface.biz.lock.*;
import cn.dface.biz.lock.annotation.Lock4j;
import cn.dface.biz.lock.autoconfig.Lock4jProperties;
...
public class LockOpsInterceptor extends AbstractConditionalLockChainInterceptor {
    ...
    @NonNull
    @Override
    protected AbstractLockInterceptor.LockOps initDefaultLockOps() {
        ...
        return new AbstractLockInterceptor.LockOpsImpl(null)
     ...
     */
    @Override
    protected Object doLock(AbstractLockInterceptor.LockOps lockOps, MethodInvocation invocation) throws Throwable {
    ...
    private String resolveKey(MethodInvocation invocation, AbstractLockInterceptor.LockOps lockOps) {
